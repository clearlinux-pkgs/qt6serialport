...
Source0  : https://download.qt.io/official_releases/qt/6.8/6.8.0/submodules/qtserialport-everywhere-src-6.8.0.zip
...
%prep
%setup -q -n qtserialport-everywhere-src-6.8.0
cd %{_builddir}/qtserialport-everywhere-src-6.8.0
pushd ..
cp -a qtserialport-everywhere-src-6.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732605903
mkdir -p clr-build
pushd clr-build
...
%files dev
%defattr(-,root,root,-)
/usr/include/QtSerialPort/6.8.0/QtSerialPort/private/qserialport_p.h
/usr/include/QtSerialPort/6.8.0/QtSerialPort/private/qserialportinfo_p.h
/usr/include/QtSerialPort/6.8.0/QtSerialPort/private/qtserialport-config_p.h
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libQt6SerialPort.so.6.8.0
/usr/lib64/libQt6SerialPort.so.6
/usr/lib64/libQt6SerialPort.so.6.8.0
