...
Version  : 6.7.3
Release  : 18
URL      : https://download.qt.io/official_releases/qt/6.7/6.7.3/submodules/qtserialport-everywhere-src-6.7.3.zip
Source0  : https://download.qt.io/official_releases/qt/6.7/6.7.3/submodules/qtserialport-everywhere-src-6.7.3.zip
...
%prep
%setup -q -n qtserialport-everywhere-src-6.7.3
cd %{_builddir}/qtserialport-everywhere-src-6.7.3
pushd ..
cp -a qtserialport-everywhere-src-6.7.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727840474
mkdir -p clr-build
pushd clr-build
...
%files dev
%defattr(-,root,root,-)
/usr/include/QtSerialPort/6.7.3/QtSerialPort/private/qserialport_p.h
/usr/include/QtSerialPort/6.7.3/QtSerialPort/private/qserialportinfo_p.h
/usr/include/QtSerialPort/6.7.3/QtSerialPort/private/qtserialport-config_p.h
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libQt6SerialPort.so.6.7.3
/usr/lib64/libQt6SerialPort.so.6
/usr/lib64/libQt6SerialPort.so.6.7.3
