...
Source0  : https://download.qt.io/official_releases/qt/6.7/6.7.2/submodules/qtserialport-everywhere-src-6.7.2.zip
...
%prep
%setup -q -n qtserialport-everywhere-src-6.7.2
cd %{_builddir}/qtserialport-everywhere-src-6.7.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718936227
mkdir -p clr-build
pushd clr-build
...
%files dev
%defattr(-,root,root,-)
/usr/include/QtSerialPort/6.7.2/QtSerialPort/private/qserialport_p.h
/usr/include/QtSerialPort/6.7.2/QtSerialPort/private/qserialportinfo_p.h
/usr/include/QtSerialPort/6.7.2/QtSerialPort/private/qtserialport-config_p.h
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libQt6SerialPort.so.6.7.2
/usr/lib64/libQt6SerialPort.so.6
/usr/lib64/libQt6SerialPort.so.6.7.2
